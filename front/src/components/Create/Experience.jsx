...
const Edit = () => {
    ...
    const onSubmit = data => {
        ...
        axios.post('http://localhost:4000/api/experience', formData)
            .then(res => {
                console.log(res.data)
                navigate('/')
            }).catch(err => {
                alert(err.message + " - Erreur lors de la création de l'experience")
            });
    }

    return (
        <>
            <MainTitle>Créer une partie de la section Expérience</MainTitle>
